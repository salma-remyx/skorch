...
- `Schedule-free optimization <https://skorch.readthedocs.io/en/stable/callbacks.html#skorch.callbacks.ScheduleFree>`_ (support for optimizers that need no learning rate schedule)
