...
- `Schedule-free optimizers <https://skorch.readthedocs.io/en/stable/callbacks.html#skorch.callbacks.LRScheduler>`_ (``skorch.schedule_free``, no learning rate schedule needed)
